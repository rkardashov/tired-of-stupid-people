...
:: Android packaging
set AND_CERT_NAME="tosp-mobile"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\tosp-mobile.p12
...
set IOS_PROVISION=cert\tosp-mobile.mobileprovision
...
:: Output packages
set DIST_PATH=dist
set DIST_NAME=tosp-mobile

:: Debugging using a custom IP
set DEBUG_IP=192.168.1.47
